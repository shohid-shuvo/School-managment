<?php
// $url = "/student/list_student.php";
// echo "Full URL: " . $_SERVER['HTTP_HOST'] . '/' . $url;
            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        ...
                        <img src="../assets/image/dashboard.png" class="me-2" width="24px" height="24px"  alt="Dashboard icon"> <span class="align-middle">Dashboard</span>
                        </a>
                    </li>
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="../database/logout.php">Log out</a>
                            </div>
                        </li>
                    </ul>
                </div>
